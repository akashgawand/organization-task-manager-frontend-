  ...
  return (
    <div className="min-h-screen flex selection:bg-[rgb(var(--color-accent))]/30 bg-[rgb(var(--color-background))]">
      ...
      <div className="hidden lg:flex w-[70%] relative flex-col justify-between overflow-hidden bg-[rgb(var(--color-surface))] border-r border-[rgb(var(--color-border))]">
        ...
        <div
          className="absolute top-[-15%] left-[-10%] w-[50rem] h-[50rem] rounded-full bg-[rgb(var(--color-accent))]/5 mix-blend-screen opacity-50 animate-pulse"
          style={{ animationDuration: "8s" }}
        />
        <div
          className="absolute top-[40%] right-[-10%] w-[40rem] h-[40rem] rounded-full bg-[rgb(var(--color-accent-hover))]/5 mix-blend-screen opacity-30 animate-pulse"
        ...
        <div className="absolute inset-0 flex flex-col justify-center z-10 px-12 lg:px-20 max-w-5xl">
          {" "}
          ...
          <h2 className="text-5xl xl:text-7xl font-bold text-[rgb(var(--color-text-primary))] leading-[1.1] tracking-tight mb-8 drop-shadow-md">
            Unify Your Tasks.
            <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[rgb(var(--color-accent))] to-[rgb(var(--color-accent-hover))]">
              Accelerate Output.
            </span>
          </h2>
          <p className="text-lg xl:text-xl text-[rgb(var(--color-text-secondary))] max-w-2xl leading-relaxed font-medium">
            Elevate organizational productivity with an enterprise-ready project
            management ecosystem. Align teams, optimize resources, and generate
