...
export default function KanbanBoard({
  ...
  return (
    <div className="flex gap-4 overflow-x-auto pb-4">
      {statusColumns
        .filter((column) => !(isRestrictedRole && column.status === "done"))
        .map((column) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                {/* Only show Add button if not restricted, or if restricted it's not the Done column. 
                  Actually, typically anyone can add To Do tasks, but restricted can't add Done tasks directly. */}
                {(!isRestrictedRole || column.status !== "done") && (
                  <button
